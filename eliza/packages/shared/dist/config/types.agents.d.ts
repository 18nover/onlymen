 ...
 */
import type { CharacterSettings, DocumentSourceItem, GroupChatConfig, HumanDelayConfig, IdentityConfig } from "@elizaos/core";
import type { AgentDefaultsConfig, SandboxBrowserSettings, SandboxDockerSettings, SandboxPruneSettings } from "./types.agent-defaults.js";
import type { AgentToolsConfig, MemorySearchConfig } from "./types.tools.js";
export type AgentKnowledgeSource = DocumentSourceItem | string | {
    path: string;
    shared?: boolean;
} | {
    directory: string;

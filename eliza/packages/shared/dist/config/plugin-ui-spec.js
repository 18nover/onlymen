 ...
 */
export function buildPluginConfigUiSpec(plugin) {
    const elements = {};
    const rootChildren = [];
    const state = {
        pluginId: plugin.id,
    ...
    for (const param of plugin.parameters) {
        ...
        const isSecret = param.key.includes("KEY") ||
 ...
 */
export function buildPluginListUiSpec(plugins, title) {
    const elements = {};
    const cardIds = [];
    elements.heading = {
        type: "Heading",
...
//# sourceMappingURL=plugin-ui-spec.js.map
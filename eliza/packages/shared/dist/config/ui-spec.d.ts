...
export type DynamicProp<T = string> = T | {
    $path: string;
};
...
export type UiSpecVisibilityCondition = PathVisibility | AuthVisibility | AndVisibility | OrVisibility | NotVisibility;
/** Built-in validator function names. */
export type BuiltinValidator = "required" | "email" | "minLength" | "maxLength" | "pattern" | "min" | "max";
...
export type UiComponentType = "Stack" | "Grid" | "Card" | "Separator" | "Heading" | "Text" | "Input" | "Textarea" | "Select" | "Checkbox" | "Radio" | "Switch" | "Slider" | "Toggle" | "ToggleGroup" | "ButtonGroup" | "Table" | "Carousel" | "Badge" | "Avatar" | "Image" | "Alert" | "Progress" | "Rating" | "Skeleton" | "Spinner" | "Button" | "Link" | "DropdownMenu" | "Tabs" | "Pagination" | "Metric" | "BarGraph" | "LineGraph" | "Tooltip" | "Popover" | "Collapsible" | "Accordion" | "Dialog" | "Drawer" | "ProfileOverview" | "InfrastructureOverview" | "PermissionMatrix";

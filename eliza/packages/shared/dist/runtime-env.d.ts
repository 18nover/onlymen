...
export declare const API_EXPOSE_PORT_KEYS: readonly ["ELIZA_API_EXPOSE_PORT"];
...
export declare function isDevApiWatchEnabled(env?: RuntimeEnvRecord, execArgv?: readonly string[]): boolean;
 ...
 */
export declare function resolveApiExposePort(env?: RuntimeEnvRecord): boolean;
...
export declare function isIosMobile(env?: RuntimeEnvRecord): boolean;
/**
 ...
 */
export declare function resolvePlatform(env?: RuntimeEnvRecord): string | undefined;

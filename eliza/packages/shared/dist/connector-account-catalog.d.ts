 ...
 */
export type ConnectorAccountCatalogPurpose = "messaging" | "posting" | "reading" | "calendar" | "drive" | "meet";
/**
 ...
 */
export declare const CONNECTOR_ACCOUNT_CATALOG: readonly ConnectorAccountCatalogEntry[];
/**
 ...
 */
export declare function getConnectorAccountCatalogEntry(connectorId: string | undefined | null): ConnectorAccountCatalogEntry | null;
/** Whether the given connector id has a plugin-managed account catalog entry. */
export declare function hasConnectorAccountCatalogEntry(connectorId: string | undefined | null): boolean;
//# sourceMappingURL=connector-account-catalog.d.ts.map
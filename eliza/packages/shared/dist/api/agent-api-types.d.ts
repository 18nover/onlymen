 ...
 */
import type { TriggerConfig, TriggerKind, TriggerLastStatus, TriggerRunRecord, TriggerType, TriggerWakeMode, UUID } from "@elizaos/core";
...
export interface TriggerTaskMetadata {
    ...
    [key: string]: string | number | boolean | string[] | number[] | Record<string, string | number | boolean> | undefined | TriggerConfig | TriggerRunRecord[];
}

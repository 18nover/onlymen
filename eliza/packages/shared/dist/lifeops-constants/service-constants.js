...
export const DEFAULT_REMINDER_INTENSITY = "normal";
export const GLOBAL_REMINDER_PREFERENCE_CHANNEL_REF = "lifeops://owner/reminder-preferences";
...
export const REMINDER_ESCALATION_STARTED_AT_METADATA_KEY = "reminderEscalationStartedAt";
export const REMINDER_ESCALATION_LAST_ATTEMPT_AT_METADATA_KEY = "reminderEscalationLastAttemptAt";
export const REMINDER_ESCALATION_LAST_CHANNEL_METADATA_KEY = "reminderEscalationLastChannel";
export const REMINDER_ESCALATION_LAST_OUTCOME_METADATA_KEY = "reminderEscalationLastOutcome";
export const REMINDER_ESCALATION_CHANNELS_METADATA_KEY = "reminderEscalationChannels";
export const REMINDER_ESCALATION_RESOLVED_AT_METADATA_KEY = "reminderEscalationResolvedAt";
export const REMINDER_ESCALATION_RESOLUTION_METADATA_KEY = "reminderEscalationResolution";
export const REMINDER_ESCALATION_RESOLUTION_NOTE_METADATA_KEY = "reminderEscalationResolutionNote";
export const REMINDER_ESCALATION_PROFILE_METADATA_KEY = "reminderEscalationProfile";
export const REMINDER_REVIEW_AFTER_MINUTES_METADATA_KEY = "reminderReviewAfterMinutes";
...
export const REMINDER_REVIEW_RESPONDED_AT_METADATA_KEY = "reminderReviewRespondedAt";
export const REMINDER_REVIEW_RESPONSE_TEXT_METADATA_KEY = "reminderReviewResponseText";
export const REMINDER_REVIEW_CLASSIFIER_SOURCE_METADATA_KEY = "reminderReviewClassifierSource";
export const REMINDER_REVIEW_SEMANTIC_REASON_METADATA_KEY = "reminderReviewSemanticReason";
export const REMINDER_REVIEW_ESCALATED_AT_METADATA_KEY = "reminderReviewEscalatedAt";
export const REMINDER_REVIEW_ESCALATED_ATTEMPT_ID_METADATA_KEY = "reminderReviewEscalatedAttemptId";
export const REMINDER_REVIEW_ESCALATED_CHANNEL_METADATA_KEY = "reminderReviewEscalatedChannel";
export const REMINDER_ACTIVITY_GATE_METADATA_KEY = "reminderActivityGate";
export const REMINDER_ACTIVITY_GATES = ["active_on_computer"];
export const REMINDER_URGENCY_METADATA_KEY = "reminderUrgency";
export const REMINDER_URGENCY_LEGACY_METADATA_KEY = "urgency";
export const reminderProcessingQueues = new Map();
export const LIFEOPS_TIME_ZONE_ALIASES = {
...
export const REMINDER_ESCALATION_DELAYS = {
...
export const DEFAULT_CALENDAR_REMINDER_STEPS = [
    {
        channel: "in_app",
        offsetMinutes: 30,
...
export const DEFAULT_WORKFLOW_PERMISSION_POLICY = {
...
export const REMINDER_INTENSITY_CANONICAL_ALIASES = {
    minimal: "minimal",
    normal: "normal",

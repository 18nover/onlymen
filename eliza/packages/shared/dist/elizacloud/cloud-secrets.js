...
export function clearCloudSecrets() {
    for (const key of [
        "ELIZAOS_CLOUD_API_KEY",
        "ELIZAOS_CLOUD_ENABLED",
    ]) {
...
export function _resetCloudSecretsForTesting() {
    for (const key of Object.keys(_cloudSecrets)) {
        delete _cloudSecrets[key];
    }
}
//# sourceMappingURL=cloud-secrets.js.map
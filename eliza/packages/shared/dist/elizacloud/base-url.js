...
function normalizeMalformedCandidate(candidate) {
    const truncated = candidate.length > 8192 ? candidate.slice(0, 8192) : candidate;
...
export function normalizeCloudSiteUrl(rawUrl) {
...
export function resolveCloudApiBaseUrl(rawUrl) {

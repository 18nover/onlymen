 ...
 */
import { addLanguageRule, DEFAULT_CHARACTER_LANGUAGE as DEFAULT_LANGUAGE, normalizeCharacterLanguage, } from "./character-language.js";
...
function mergeSharedStyleRules(all) {
    const merged = [...all];
...
function resolveCharacterVariant(definition, language) {
...
let DEFAULT_AGENT_NAME_OVERRIDE = null;
export function setDefaultAgentName(name) {
...
export const STYLE_PRESETS = STYLE_PRESET_CACHE[DEFAULT_LANGUAGE];
export function getDefaultStylePreset(language = DEFAULT_LANGUAGE) {
...
export function resolveStylePresetById(id, language = DEFAULT_LANGUAGE) {
    if (!id) {
        return undefined;
    }
...
export function resolveStylePresetByName(name, language = DEFAULT_LANGUAGE) {
    if (!name) {
        return undefined;
    }
    const normalized = normalizeCharacterLanguage(language);
...
export function resolveStylePresetByAvatarIndex(avatarIndex, language = DEFAULT_LANGUAGE) {
...
export const CHARACTER_PRESET_META = Object.fromEntries(STYLE_PRESETS.map((preset) => [
    preset.catchphrase,
    {
        id: preset.id,
        name: preset.name,
...
export function getPresetNameMap(language = DEFAULT_LANGUAGE) {
    const result = {};
...
//# sourceMappingURL=character-presets.js.map
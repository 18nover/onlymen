 ...
 */
export type HostModuleImporter = (specifier: string) => Promise<Record<string, unknown>>;
/**
 ...
 */
export type HostExternalBundleFactory = (hostImport: HostModuleImporter) => Promise<Record<string, unknown>>;
/** URL query flag the loader sets to request the host-external factory serve. */
export declare const HOST_EXTERNAL_RUNTIME_PARAM = "hostExternalRuntime";
/** URL query key carrying the comma-joined host-external specifier list. */
export declare const HOST_EXTERNAL_SPECIFIERS_PARAM = "hostExternalSpecifiers";
//# sourceMappingURL=host-external-contract.d.ts.map
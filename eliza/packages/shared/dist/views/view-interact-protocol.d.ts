...
export declare const STANDARD_CAPABILITIES: {
    ...
    readonly FOCUS_ELEMENT: "focus-element";
    /** Returns the visible text content of the view container. */
    readonly GET_TEXT: "get-text";
    ...
    readonly CLICK_ELEMENT: "click-element";
    ...
    readonly FILL_INPUT: "fill-input";
};
 ...
 * handling.
 */
export declare const AGENT_SURFACE_CAPABILITY_IDS: ReadonlySet<string>;
//# sourceMappingURL=view-interact-protocol.d.ts.map
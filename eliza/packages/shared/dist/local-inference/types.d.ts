 ...
 */
export type TokenizerFamily = "gemma4" | "eliza1" | "sentencepiece" | (string & {});
export type CatalogHub = "huggingface" | "modelscope";
export type CatalogQuantizationId = "q3_k_m" | "q4_0" | "q4_k_m" | "q5_k_m" | "q6_k" | "q8_0" | "wna8o8";
...
export interface CatalogModel {
    ...
    sourceModel?: {
        finetuned: false;
        components: Partial<Record<"text" | "voice" | "asr" | "vad" | "embedding" | "vision" | "litert" | "mtp", {
            repo: string;
            file?: string;
        }>>;
    };

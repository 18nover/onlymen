 ...
 * checksums.
 */
export const VOICE_MODEL_VERSIONS = [
    {
        id: "wakeword",
        version: "0.3.0",
        parentVersion: "0.2.0",
        ...
        ggufAssets: [
            {
                ...
                sha256: "98bd2d5e3cc09e416626cd1a6a758cb92bb8096766d25ecf57d4c99927db682d",
                sizeBytes: 543584,
                quant: "fp16",
            },
            {
                filename: "voice/wakeword/hey-eliza.embedding.gguf",
                sha256: "9cfcb0d9f1939c68cc9e63f5ac9e0f09b8e8568ee1085dbb50e7391e874a1dc5",
                sizeBytes: 659904,
                quant: "fp16",
            },
            {
                filename: "voice/wakeword/hey-eliza.classifier.gguf",
                sha256: "4502c92664b18d598753114f09925921ddd065d72871607c3a842fa70510a350",
                sizeBytes: 315456,
                quant: "fp16",
            },
        ],
        evalDeltas: { netImprovement: true },
        changelogEntry: "0.3.0 - real hey-eliza head (no-mel-rescale, ~98pct TA / ~4-7pct FA held-out)",
    ...
    },
    {
        ...
        changelogEntry: "LiveKit v1.2.2-en fine-tuned on DailyDialog (prefix-augmented EOU corpus, APOLLO-Mini, F1=0.9811 vs 0.84 baseline)",
        minBundleVersion: "0.0.0",
    },
    {
        id: "speaker-encoder",
        ...
        ggufAssets: [
            {
                ...
                sha256: "ad066730b125f61a305c949f7f196d23681f387f3e3f916be7a4cd003aae6ae3",
                sizeBytes: 26_525_824,
                quant: "gguf-fp32",
            },
        ],
        evalDeltas: { netImprovement: true },
        changelogEntry: "0.2.0 — GGUF conversion via voice_speaker_to_gguf.py; ONNX file removed from HF. GGUF published to HF.",
        minBundleVersion: "0.0.0",
    },
    {
        id: "speaker-encoder",
        ...
        evalDeltas: { netImprovement: true },
        changelogEntry: "Initial release — WeSpeaker ResNet34-LM 256-dim ONNX (deprecated; GGUF in 0.2.0).",
        minBundleVersion: "0.0.0",
    },
    {
        id: "diarizer",
        ...
        ggufAssets: [
            {
                ...
                sha256: "100a5dbfd480b0cd6b0e01f0a9974ba836412721dfa0e36b7c1bb5a041abfbde",
                sizeBytes: 5_976_032,
                quant: "gguf-fp32",
            },
        ],
        evalDeltas: { netImprovement: true },
        changelogEntry: "0.3.0 — epoch-2 IFGO re-bake (#11377): converter_epoch=2 + lstm_gate_order=IFGO metadata; " +
        ...
        ggufAssets: [
            {
                ...
                sha256: "30983eba41c0a99ab7eada564739ae8be74faeb21a31da759c870b5173cbd8a5",
                sizeBytes: 5_975_424,
                quant: "gguf-fp32",
            },
        ],
        evalDeltas: { netImprovement: true },
        changelogEntry: "0.2.0 — GGUF conversion via voice_diarizer_to_gguf.py; ONNX files removed from HF. GGUF published to HF.",
        minBundleVersion: "0.0.0",
    },
    {
        id: "diarizer",
        ...
        evalDeltas: { netImprovement: true },
        changelogEntry: "Initial release — Pyannote-segmentation-3.0 ONNX int8 (deprecated; GGUF in 0.2.0).",
        minBundleVersion: "0.0.0",
    },
    {
        id: "turn-detector",
    ...
    },
    {
        ...
        evalDeltas: { netImprovement: true },
        changelogEntry: "0.3.0 — GGUF conversion via voice_emotion_to_gguf.py; ONNX files removed from HF.",
        minBundleVersion: "0.0.0",
    },
    {
        id: "voice-emotion",
        ...
        changelogEntry: "v0.2.0 — Wav2Small cls7 head shipped (macro-F1=0.355 > 0.35 gate). ONNX files deprecated; GGUF in 0.3.0.",
        minBundleVersion: "0.0.0",
    },
    {
        ...
        changelogEntry: "0.3.0 — J2: fork-side Kokoro inference path (LLM_ARCH_KOKORO graph + tools/kokoro/). Runtime selector defaults to KOKORO_BACKEND=fork → llama-server /v1/audio/speech. ONNX path retained for one release. Quality gap vs ONNX baseline documented; compute-gated follow-up for full per-tensor weight mapping.",
        minBundleVersion: "0.0.0",
    },
    {
        id: "kokoro",
        ...
        changelogEntry: "0.2.0 — af_sam shipped per user override (I2); eval WER=1.0/UTMOS=2.32/SpkSim=0.15, gate=FAIL. OmniVoice preset remains production sam voice. compute-gated: needs ≥3h corpus for real quality.",
        minBundleVersion: "0.0.0",
    },
    {
        id: "kokoro",
        ...
        evalDeltas: { netImprovement: true },
        changelogEntry: "Initial release — kokoro 82M voice-embedding af_bella preset (ONNX deprecated; fork GGUF path in 0.3.0).",
        minBundleVersion: "0.0.0",
    },
    {
        id: "vad",
        ...
        ggufAssets: [
            ...
            },
            {
                ...
                sha256: "d348cd6d87ea53dcd3e6680698c88be326082e27dae899adef653d090bee4995",
                sizeBytes: 620_736,
                quant: "gguf-fp32",
            },
        ],
    ...
    },
    {
        ...
        evalDeltas: { netImprovement: true },
        changelogEntry: "Initial release — Silero VAD v5 GGUF (ONNX file deprecated; removed in 0.2.0).",
        minBundleVersion: "0.0.0",
    },
    {
        id: "wakeword",
        ...
        evalDeltas: { netImprovement: true },
        changelogEntry: "0.2.0 — ONNX files removed from HF; combined openwakeword.gguf target.",
        minBundleVersion: "0.0.0",
    },
    {
        id: "wakeword",
        ...
        evalDeltas: { netImprovement: true },
        changelogEntry: "Initial release — hey-eliza wake-word head ONNX (deprecated; removed in 0.2.0).",
        minBundleVersion: "0.0.0",
    },
    {
        id: "embedding",
    ...
    },
    {
        ...
        evalDeltas: { netImprovement: true },
        changelogEntry: "Gemma ASR cutover placeholder — pre-Gemma ASR assets retired; downloads stay disabled until Gemma ASR artifacts are published.",
    ...
    },
    {
        ...
        evalDeltas: { netImprovement: true },
        changelogEntry: "Retired pre-Gemma ASR release — streaming transcriber Q8_0.",
        minBundleVersion: "0.0.0",
    },
    {
        id: "asr",
        ...
        ggufAssets: [
            {
                ...
                sha256: "80c046bf44cf52699bcef0f5a10d9774a0415c127432a0d0f428e6f1634d7f12",
                sizeBytes: 1_073_237_952,
                quant: "q3_k_m",
            },
            {
                filename: "voice/asr/eliza-1-asr-q4_k_m.gguf",
                sha256: "de11f7110e6faddc277088262cffe8adc3228220a1cfd133c49420bb8bd3c3c5",
                sizeBytes: 1_282_435_008,
                quant: "q4_k_m",
            },
            {
                filename: "voice/asr/eliza-1-asr-q5_k_m.gguf",
                sha256: "dcffc861bc968202a6ca1107f3335c3dfcd89d6945ca87569596d6a9f551207a",
                sizeBytes: 1_471_801_280,
                quant: "q5_k_m",
            },
            {
                filename: "voice/asr/eliza-1-asr-q6_k.gguf",
                sha256: "b0f6f2d610dfcc95c4147271855d1aadf78d298d193666834912eb600c5eaf0b",
        ...
        evalDeltas: { netImprovement: true },
        changelogEntry: "Retired pre-Gemma ASR K-quant ladder: Q3_K_M, Q4_K_M, Q5_K_M, Q6_K. Kept only as historical release metadata; active downloads remain on the Gemma ASR placeholder until verified artifacts are hosted.",
        minBundleVersion: "0.0.0",
    },
];
/**
 ...
 */
export function compareVoiceModelSemver(a, b) {
    const parse = (s) => {
 ...
 */
export function voiceModelAssetUrl(version, asset) {
...
export function versionsFor(id) {
...
export function latestVoiceModelVersion(id) {
    return versionsFor(id)[0];
}
/** Lookup by id + exact version. */
export function findVoiceModelVersion(id, version) {

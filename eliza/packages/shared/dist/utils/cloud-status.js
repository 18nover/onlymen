 ...
 */
const CLOUD_STATUS_API_KEY_ONLY_REASONS = new Set([
    "api_key_present_not_authenticated",
    "api_key_present_runtime_not_started",
]);
export function isCloudStatusReasonApiKeyOnly(reason) {
    return (typeof reason === "string" && CLOUD_STATUS_API_KEY_ONLY_REASONS.has(reason));
}
export function isCloudStatusAuthenticated(connected, reason) {

 ...
 */
export function computeErle(nearEnd, residual) {
    let nearEnergy = 0;
 ...
 */
export function computeFarActiveErle(nearEnd, residual, alignedFarEnd, options = {}) {
...
//# sourceMappingURL=echo-metrics.js.map
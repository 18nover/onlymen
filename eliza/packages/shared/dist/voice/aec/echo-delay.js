 ...
 */
export function estimateEchoDelaySamples(near, far, options = {}) {
 ...
 */
export const PLATFORM_PLAYBACK_DELAY_DEFAULTS = {
 ...
 */
export function platformPlaybackDelayMs(platform) {
 ...
 */
export function platformPlaybackDelaySamples(platform, sampleRate = 16_000) {
    return Math.round((platformPlaybackDelayMs(platform) / 1000) * sampleRate);
}
//# sourceMappingURL=echo-delay.js.map
...
export const PostFirstRunRequestSchema = z
    ...
    for (const key of FIRST_RUN_DEPRECATED_FIELD_KEYS) {
        if (Object.hasOwn(value, key)) {
            ctx.addIssue({
                code: "custom",
                message: "deprecated first-run payloads are no longer supported; send deploymentTarget, linkedAccounts, serviceRouting, and credentialInputs",
            });
            return;
        }
    }
...
//# sourceMappingURL=first-run-routes.js.map
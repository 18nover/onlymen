...
export type LifeOpsReminderReviewStatus = "unrelated" | "needs_clarification" | "no_response" | "resolved" | "escalated" | "clarification_requested";
 ...
 */
export type LifeOpsActivitySignalSourceName = LifeOpsActivitySignalSource | (string & {});
/**
 ...
 */
export declare function isBuiltinActivitySignalSource(source: LifeOpsActivitySignalSourceName): source is LifeOpsActivitySignalSource;
...
export type LifeOpsTelemetryMessageChannel = "gmail" | "x_dm" | "discord" | "telegram" | "signal" | "imessage" | "whatsapp" | "sms" | "eliza_chat";
...
export declare const LIFEOPS_GMAIL_MANAGE_EXECUTION_MODES: readonly ["proposal", "dry_run", "execute"];
export type LifeOpsGmailManageExecutionMode = (typeof LIFEOPS_GMAIL_MANAGE_EXECUTION_MODES)[number];
export declare const LIFEOPS_GMAIL_MANAGE_STATUSES: readonly ["proposed", "dry_run", "approved", "executed", "partial", "failed", "cancelled"];
export type LifeOpsGmailManageStatus = (typeof LIFEOPS_GMAIL_MANAGE_STATUSES)[number];
export declare const LIFEOPS_GMAIL_MANAGE_UNDO_STATUSES: readonly ["not_available", "available", "completed", "expired", "failed"];
export type LifeOpsGmailManageUndoStatus = (typeof LIFEOPS_GMAIL_MANAGE_UNDO_STATUSES)[number];
 ...
 */
export declare const LIFEOPS_INBOX_SOURCES: readonly ["chat", "gmail", "x_dm"];
export type LifeOpsInboxSource = (typeof LIFEOPS_INBOX_SOURCES)[number];
export declare const LIFEOPS_INBOX_SOURCE_STATES: readonly ["ok", "degraded", "disconnected"];
export type LifeOpsInboxSourceState = (typeof LIFEOPS_INBOX_SOURCE_STATES)[number];
/**
...
export declare const LIFEOPS_INBOX_CACHE_MODES: readonly ["read-through", "refresh", "cache-only"];
...
export declare const LIFEOPS_OWNER_BROWSER_ACCESS_SOURCES: readonly ["lifeops_browser", "desktop_browser", "discord_desktop"];
export type LifeOpsOwnerBrowserAccessSource = (typeof LIFEOPS_OWNER_BROWSER_ACCESS_SOURCES)[number];
export declare const LIFEOPS_OWNER_BROWSER_TAB_STATES: readonly ["missing", "background_discord", "discord_open", "dm_inbox_visible"];
export type LifeOpsOwnerBrowserTabState = (typeof LIFEOPS_OWNER_BROWSER_TAB_STATES)[number];
export declare const LIFEOPS_OWNER_BROWSER_AUTH_STATES: readonly ["unknown", "logged_out", "logged_in"];
export type LifeOpsOwnerBrowserAuthState = (typeof LIFEOPS_OWNER_BROWSER_AUTH_STATES)[number];
export declare const LIFEOPS_OWNER_BROWSER_NEXT_ACTIONS: readonly ["none", "connect_browser", "open_extension_popup", "enable_browser_access", "enable_browser_control", "open_discord", "open_dm_inbox", "focus_discord_manually", "focus_dm_inbox_manually", "log_in", "open_desktop_browser", "relaunch_discord"];
export type LifeOpsOwnerBrowserNextAction = (typeof LIFEOPS_OWNER_BROWSER_NEXT_ACTIONS)[number];

...
export const ListAppPermissionsResponseSchema = z.array(AppPermissionsViewSchema);
...
export const APP_PERMISSIONS_ROUTE_PATHS = {
    ...
    get: (slug) => `/api/apps/permissions/${encodeURIComponent(slug)}`,
    put: (slug) => `/api/apps/permissions/${encodeURIComponent(slug)}`,
};
//# sourceMappingURL=app-permissions-routes.js.map
...
export const PostLaunchAppRequestSchema = NameOnlyRequestBase.transform(trimName).pipe(z.object({ name: z.string().min(1, "name is required") }).strict());
...
export const PostStopAppRequestSchema = z
    ...
    (value.runId && value.runId.trim().length > 0), { message: "name or runId is required" })
    .transform((value) => ({
...
//# sourceMappingURL=apps-lifecycle-routes.js.map
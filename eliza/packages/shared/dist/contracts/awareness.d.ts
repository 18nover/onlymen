...
export declare const SELF_STATUS_SCHEMA_VERSION = 1;
/** Max chars for a single contributor summary line. */
export declare const SUMMARY_CHAR_LIMIT = 80;
/** Max total chars for the composed Layer 1 output (~300 tokens). */
export declare const SUMMARY_TOTAL_CHAR_LIMIT = 1200;
/** Default cache TTL in ms (1 minute). */
export declare const DEFAULT_CACHE_TTL_MS = 60000;
export type AwarenessInvalidationEvent = "permission-changed" | "plugin-changed" | "wallet-updated" | "provider-changed" | "config-changed" | "runtime-restarted" | "opinion-updated";

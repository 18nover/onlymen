 ...
 */
export const NATURAL_BACKGROUND_META = [
    {
        id: "misty-forest",
        label: "Misty Forest",
 ...
 */
export const PHOTO_BACKGROUND_META = [
    {
        id: "dusk-dunes",
        label: "Dusk Dunes",
    ...
    },
    {
        id: "ember-dunes",
        label: "Ember Dunes",
        description: "Ember-orange dunes under a warm amber sky, birds on the wing.",
        kind: "image",
        mood: "warm",
 ...
 */
export const GLSL_BACKGROUND_META = [
    {
        id: "aurora",
        label: "Aurora",
 ...
 */
export const BACKGROUND_CATALOG_INDEX = [
 ...
 * action.
 */
export const IMAGE_BACKGROUND_META = [
    ...NATURAL_BACKGROUND_META,
    ...PHOTO_BACKGROUND_META,
];
 ...
 */
export function matchCatalogId(ref) {
    if (!ref)
        return undefined;
    ...
    if (byId)
        return byId.id;
    const byLabel = BACKGROUND_CATALOG_INDEX.find((e) => e.label.toLowerCase() === needle);
    if (byLabel)
        return byLabel.id;
 ...
 */
export function detectCatalogId(text) {

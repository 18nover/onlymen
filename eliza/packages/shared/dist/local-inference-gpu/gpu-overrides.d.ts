...
import { type GpuYamlProfile, type KvCacheType } from "./gpu-profile-schema.js";
/**
 ...
 */
export declare function getGpuOverrides(input: GpuOverridesInput): GpuOverridesResult;
/**
 ...
 */
export declare const MTP_SERVER_PATCH_DOCS = "see comment block above MTP_SERVER_PATCH_DOCS";
//# sourceMappingURL=gpu-overrides.d.ts.map
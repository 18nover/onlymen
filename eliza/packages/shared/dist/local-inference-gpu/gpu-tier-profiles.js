...
const RTX_3090 = {
    ...
    notes: "24 GB GDDR6X. Best fit is Eliza-1 9B with 4B/2B fallbacks. MTP enabled with the 2B drafter.",
};
const RTX_4090 = {
    id: "rtx-4090",
    ...
    notes: "24 GB GDDR6X, Ada Lovelace. FP8 available. Runs Eliza-1 27B with compressed KV and keeps 9B/4B as fast fallbacks.",
};
const RTX_5090 = {
    id: "rtx-5090",
    ...
    notes: "32 GB GDDR7, Blackwell. FP4 available. Best fit is the 27B 256k bundle with 27B and 9B fallbacks.",
};
const H200 = {
    id: "h200",
    ...
    notes: "141 GB HBM3e. SXM5 form factor. Best fit is the 27B 256k bundle (262k natural context). MTP uses the 4B drafter for high throughput.",
};
// ---------------------------------------------------------------------------
// Public registry
// ---------------------------------------------------------------------------
 ...
 */
export function getGpuProfile(id) {
 ...
 * supported cards).
 */
export function selectBestProfile(vramGb, cudaCompute) {
 ...
 */
export function buildLlamaCppArgs(profile, overrides) {
...
//# sourceMappingURL=gpu-tier-profiles.js.map
# Release Notes Template — Scribe Knowledge Base
...
Scribe's job here is narrow: writing the **changeset entry** for a PR (a
...
- Every entry traceable back to a merged PR for Scribe's own fact-checking,

# Audit Checklist — Audrey Knowledge Base
...
|------------|-----------|-------|---------|
| Security (vulnerabilities) | Weekly | Audrey | 30 min |
| Dependencies (updates) | Biweekly | Audrey | 1 hour |
| Full code audit | Monthly | Audrey + team | 2–4 hours |
| Performance audit | Monthly | Nadia | 2 hours |
| Documentation review | Quarterly | Andrew | 1 hour |
| License compliance | Quarterly | Audrey | 30 min |

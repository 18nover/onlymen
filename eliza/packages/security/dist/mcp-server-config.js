...
import { isBlockedPrivateOrLinkLocalIp, normalizeHostLike, } from "./network-policy.js";
...
function blockedMcpEnvPrefix(upperKey) {
...
function rejectMcpEnvEntry(key, value) {

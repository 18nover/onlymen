 ...
 */
export declare abstract class MobileDeviceBridgeService extends Service {
    static serviceType: typeof ServiceType.MOBILE_DEVICE_BRIDGE;
    abstract getMobileDeviceBridgeStatus(): MobileDeviceBridgeStatus;
    abstract loadMobileDeviceBridgeModel(modelPath: string, modelId?: string): Promise<void>;
    abstract unloadMobileDeviceBridgeModel(): Promise<void>;
}
//# sourceMappingURL=mobile-device-bridge-service.d.ts.map
...
import type { JsonValue, Metadata, UUID } from "./primitives.js";
...
export declare const DbRunStatus: {
...
export type ConnectorAccountJsonObject = {
 ...
 */
export interface MemoryRetrievalOptions extends Omit<MemoryRetrievalOptionsBase, "roomId" | "agentId" | "start" | "end"> {
    roomId: UUID;
    agentId?: UUID;
    start?: number | bigint;
    end?: number | bigint;
 ...
 */
export interface MemorySearchOptions extends Omit<MemorySearchOptionsBase, "roomId" | "agentId" | "metadata" | "matchThreshold"> {
    roomId: UUID;
    agentId?: UUID;
 ...
 */
export interface MultiRoomMemoryOptions extends Omit<MultiRoomMemoryOptionsBase, "roomIds" | "agentId"> {
    roomIds: UUID[];
    agentId?: UUID;
}
/**

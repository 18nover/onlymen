 ...
 */
import type { ConnectorAccountPolicy } from "./connector-account-policy.js";
import type { AgentContext, CacheScope, ContextGate, RoleGate } from "./contexts.js";
import type { Memory } from "./memory.js";
import type { Content, JsonPrimitive, JsonValue } from "./primitives.js";
import type { IAgentRuntime } from "./runtime.js";
import type { ActionPlan, State } from "./state.js";
export type { AgentContext, CacheScope, ContextGate, RoleGate, } from "./contexts.js";
/**
 ...
 */
export type ActionParameterExampleValue = ActionParameterValue | ActionParameters | JsonValue | ActionParameterValue[] | ActionParameters[];
/**
...
export interface ActionParameters {
    [key: string]: ActionParameterValue | ActionParameters | ActionParameterValue[] | ActionParameters[] | JsonValue;
}
/**
 ...
 */
export type HandlerCallback = (response: Content, actionName?: string) => Promise<Memory[]>;
/**
 * Handler function type for processing messages
 */
export type Handler = (runtime: IAgentRuntime, message: Memory, state?: State, options?: HandlerOptions | Record<string, JsonValue | undefined>, callback?: HandlerCallback, responses?: Memory[]) => Promise<ActionResult | undefined>;
/**
 ...
 */
export type Validator = (runtime: IAgentRuntime, message: Memory, state?: State, options?: HandlerOptions | Record<string, JsonValue | undefined>) => Promise<boolean>;
/**
...
export declare const ActionMode: {
    ...
    readonly ALWAYS_BEFORE: "ALWAYS_BEFORE";
    readonly ALWAYS_DURING: "ALWAYS_DURING";
    readonly ALWAYS_AFTER: "ALWAYS_AFTER";
    readonly CONTEXT_BEFORE: "CONTEXT_BEFORE";
    readonly CONTEXT_DURING: "CONTEXT_DURING";
    readonly CONTEXT_AFTER: "CONTEXT_AFTER";
    readonly RESPONSE_HANDLER_BEFORE: "RESPONSE_HANDLER_BEFORE";
    readonly RESPONSE_HANDLER_DURING: "RESPONSE_HANDLER_DURING";
    readonly RESPONSE_HANDLER_AFTER: "RESPONSE_HANDLER_AFTER";
};
...
export declare const NON_BLOCKING_MODES: Set<ActionMode>;
/** All non-PLANNER hook modes, in canonical pipeline order. */
export declare const HOOK_MODES: readonly ActionMode[];
/**
 * Represents an action the agent can perform
 */
export declare const FOLLOW_UP_CAPABLE_ACTION_TAG: "follow-up-capable";
export interface Action {
     ...
     */
    summarize?: (result: ActionResult | undefined, params: Record<string, unknown>) => string | undefined;
    /**
     ...
     * tool calls.
     */
    connectorAccountPolicy?: ConnectorAccountPolicy | readonly ConnectorAccountPolicy[];
 ...
 */
export type ProviderValue = JsonPrimitive | JsonValue | Uint8Array | bigint | object | ProviderValue[] | {
 ...
 * the strings.
 */
export type ActionConfirmationStatus = "CONFIRMATION_REQUIRED" | "NOT_CONFIRMED" | "REQUIRES_CONFIRMATION" | "AWAITING_CONFIRMATION" | "NEEDS_CONFIRMATION";
/**
 * Runtime set of {@link ActionConfirmationStatus} values. Frozen so callers
 * cannot mutate the canonical list.
 */
export declare const ACTION_CONFIRMATION_STATUS_VALUES: ReadonlySet<ActionConfirmationStatus>;
/**
 ...
 */
export declare function isActionConfirmationStatus(value: unknown): value is ActionConfirmationStatus;
/**
 ...
 */
export type StreamChunkCallback = (chunk: string, messageId?: string, accumulated?: string) => void | Promise<void>;
/**

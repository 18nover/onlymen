...
export type SendHandlerFunction = (runtime: IAgentRuntime, target: TargetInfo, content: Content) => SendHandlerResult;
...
export interface IMessagingAdapter {
    ...
    createChannel(data: {
        ...
        topic?: string;
        metadata?: Metadata;
    }, participantIds?: UUID[]): Promise<MessagingChannel>;
    /**
     ...
     */
    getMessagesForChannel(channelId: UUID, limit?: number, beforeTimestamp?: Date): Promise<MessagingMessage[]>;
    /**
     * Delete a message
     */
     ...
     */
    findOrCreateDmChannel(user1Id: UUID, user2Id: UUID, messageServerId: UUID): Promise<MessagingChannel>;
}

...
import type { ContextRegistry } from "../runtime/context-registry.js";
...
import type { ResponseHandlerFieldRegistry } from "../runtime/response-handler-field-registry.js";
import type { RoomHandlerQueue } from "../runtime/room-handler-queue.js";
import type { TurnControllerRegistry } from "../runtime/turn-controller.js";
import type { PromptBatcher } from "../utils/prompt-batcher.js";
import type { Agent, Character } from "./agent.js";
import type { ChatPreHandler, ChatPreHandlerContext, ChatPreHandlerResult } from "./chat-pre-handler.js";
import type { Action, ActionMode, ActionResult, AgentContext, HandlerCallback, Provider, StreamChunkCallback } from "./components.js";
...
import type { RegisteredEvaluator } from "./evaluator.js";
...
import type { IMessagingAdapter, SendHandlerFunction, SendHandlerResult, TargetInfo } from "./messaging.js";
import type { GenerateTextOptions, GenerateTextParams, GenerateTextResult, ModelParamsMap, ModelRegistrationInfo, ModelRegistrationMetadata, ModelResultMap, ModelTypeName, TextGenerationModelType } from "./model.js";
import type { PairingAllowlistEntry, PairingRequest } from "./pairing.js";
import type { Plugin, PluginOwnership, RemotePluginInstallOptions, RemotePluginInstanceHandle, Route, RuntimeEventStorage, ServiceClass } from "./plugin.js";
import type { ChannelType, Content, JsonValue, UUID } from "./primitives.js";
import type { SearchCategoryEnumerationOptions, SearchCategoryLookupOptions, SearchCategoryRegistration } from "./search.js";
import type { Service, ServiceTypeName } from "./service.js";
import type { ShortcutDefinition } from "./shortcut.js";
import type { State } from "./state.js";
import type { Task, TaskWorker } from "./task.js";
import type { ToolPolicyConfig, ToolProfileId } from "./tools.js";
export { type SearchCategoryEnumerationOptions, type SearchCategoryFilter, type SearchCategoryFilterOption, type SearchCategoryFilterType, type SearchCategoryLookupOptions, type SearchCategoryRegistration, SearchCategoryRegistryError, type SearchCategoryRegistryErrorCode, } from "./search.js";
export type MessageTargetKind = "room" | "channel" | "thread" | "user" | "contact" | "group" | "server" | "email" | "phone" | (string & {});
export declare const CANONICAL_MESSAGE_TARGET_KINDS: readonly ["room", "channel", "thread", "user", "contact", "group", "server", "email", "phone"];
export type MessageConnectorCapability = "send_message" | "read_messages" | "search_messages" | "list_channels" | "list_servers" | "react_message" | "edit_message" | "delete_message" | "pin_message" | "join_channel" | "leave_channel" | "get_user" | "create_thread" | "post_to_thread" | "typing_indicator" | "webhook_identity" | "rich_components" | "rich_embed" | (string & {});
export type PostConnectorCapability = "post" | "read_feed" | "search_posts" | (string & {});
...
export declare const ConnectorAccountPurpose: {
...
export type ConnectorAccountPurpose = (typeof ConnectorAccountPurpose)[keyof typeof ConnectorAccountPurpose] | (string & {});
export declare const ConnectorAccountRole: {
    readonly OWNER: "OWNER";
    readonly AGENT: "AGENT";
    readonly TEAM: "TEAM";
};
export type ConnectorAccountRole = (typeof ConnectorAccountRole)[keyof typeof ConnectorAccountRole];
export declare const ConnectorAuthMethod: {
...
export type ConnectorAuthMethod = (typeof ConnectorAuthMethod)[keyof typeof ConnectorAuthMethod] | (string & {});
export declare const ConnectorAccountHealth: {
...
export type ConnectorAccountHealth = (typeof ConnectorAccountHealth)[keyof typeof ConnectorAccountHealth] | (string & {});
...
export interface MessageConnector {
    ...
    contexts: AgentContext[];
    metadata?: Metadata;
    resolveTargets?: (query: string, context: MessageConnectorQueryContext) => Promise<MessageConnectorTarget[]> | MessageConnectorTarget[];
    listRecentTargets?: (context: MessageConnectorQueryContext) => Promise<MessageConnectorTarget[]> | MessageConnectorTarget[];
    listRooms?: (context: MessageConnectorQueryContext) => Promise<MessageConnectorTarget[]> | MessageConnectorTarget[];
    getChatContext?: (target: TargetInfo, context: MessageConnectorQueryContext) => Promise<MessageConnectorChatContext | null> | MessageConnectorChatContext | null;
    getUserContext?: (entityId: UUID | string, context: MessageConnectorQueryContext) => Promise<MessageConnectorUserContext | null> | MessageConnectorUserContext | null;
    listServers?: (context: MessageConnectorQueryContext) => Promise<World[]> | World[];
    fetchMessages?: (context: MessageConnectorQueryContext, params: MessageConnectorFetchMessagesParams) => Promise<Memory[]> | Memory[];
    searchMessages?: (context: MessageConnectorQueryContext, params: MessageConnectorSearchMessagesParams) => Promise<Memory[]> | Memory[];
    reactHandler?: (runtime: IAgentRuntime, params: MessageConnectorReactionParams) => Promise<void>;
    editHandler?: (runtime: IAgentRuntime, params: MessageConnectorEditParams) => Promise<Memory> | Promise<void>;
    deleteHandler?: (runtime: IAgentRuntime, params: MessageConnectorMessageOpParams) => Promise<void>;
    pinHandler?: (runtime: IAgentRuntime, params: MessageConnectorPinParams) => Promise<void>;
    joinHandler?: (runtime: IAgentRuntime, params: MessageConnectorChannelOpParams) => Promise<Room> | Promise<void>;
    leaveHandler?: (runtime: IAgentRuntime, params: MessageConnectorChannelOpParams) => Promise<void>;
    getUser?: (runtime: IAgentRuntime, params: MessageConnectorGetUserParams) => Promise<unknown>;
    typingHandler?: (runtime: IAgentRuntime, params: MessageConnectorTypingParams) => Promise<void>;
    stopTypingHandler?: (runtime: IAgentRuntime, params: MessageConnectorTypingParams) => Promise<void>;
    createThreadHandler?: (runtime: IAgentRuntime, params: MessageConnectorCreateThreadParams) => Promise<ThreadHandle>;
    postToThreadHandler?: (runtime: IAgentRuntime, params: MessageConnectorPostToThreadParams) => Promise<Memory | undefined>;
    contentShaping?: ConnectorContentShaping;
}
export type MessageConnectorMetadata = Partial<Omit<MessageConnector, "source" | "label">> & {
    label?: string;
};
...
export interface PostConnector {
    ...
    fetchFeed?: (context: PostConnectorQueryContext, params: PostConnectorFeedParams) => Promise<Memory[]> | Memory[];
    searchPosts?: (context: PostConnectorQueryContext, params: PostConnectorSearchParams) => Promise<Memory[]> | Memory[];
    contentShaping?: ConnectorContentShaping;
}
export type PostConnectorMetadata = Partial<Omit<PostConnector, "source" | "label">> & {
    label?: string;
};
...
export interface IAgentRuntime extends IDatabaseAdapter<object> {
     ...
     */
    installRemotePlugin(plugin: Plugin, options?: RemotePluginInstallOptions): Promise<RemotePluginInstanceHandle>;
    ...
    ensureConnection({ entityId, roomId, roomName, metadata, userName, worldName, name, source, channelId, messageServerId, type, worldId, userId, }: {
        entityId: UUID;
        roomId: UUID;
        roomName?: string;
        userName?: string;
    ...
    composeState(message: Memory, includeList?: string[], onlyInclude?: boolean, skipCache?: boolean, 
    /**
     ...
     */
    refreshProviders?: string[] | null): Promise<State>;
    /**
     ...
     */
    getLastResolvedModelProvider?(modelType: TextGenerationModelType | string): string | undefined;

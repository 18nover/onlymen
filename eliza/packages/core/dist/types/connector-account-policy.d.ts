...
export type ConnectorAccountPurpose = "messaging" | "posting" | "reading" | "admin" | "automation" | (string & {});
export type ConnectorAccountAccessGate = "open" | "pairing" | "owner_binding" | "manual_approval" | "disabled" | (string & {});
export type ConnectorAccountStatus = "connected" | "pending" | "disabled" | "revoked" | "error";
...
//# sourceMappingURL=connector-account-policy.d.ts.map
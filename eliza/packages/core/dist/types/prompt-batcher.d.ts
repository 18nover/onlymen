...
export type ContextResolver = (runtime: IAgentRuntime, messages: Memory[]) => Promise<string> | string;
...
export declare class BatcherDisposedError extends Error {
    constructor();
}
export type PromptBatcherExecOptions = NonNullable<PromptSection["execOptions"]>;
export type PromptBatcherGenerateTextParams = Omit<GenerateTextParams, "prompt"> & {
    prompt: string;
};
//# sourceMappingURL=prompt-batcher.d.ts.map
...
export interface DialectAdapter {
    ...
    createTable(name: string, columns: Record<string, unknown>, constraintsFn?: (table: Record<string, unknown>) => unknown[]): unknown;
 ...
 */
export type BuildTableFn = (schema: SchemaTable, adapter: DialectAdapter) => unknown;

 ...
 */
import type { AppPackageRouteContext } from "../api/route-helpers.js";
import type { ConnectorSourceDefinition } from "../connectors.js";
...
import type { ChatPreHandler } from "./chat-pre-handler.js";
import type { Action, AgentContext, Provider } from "./components.js";
...
import type { ModelParamsMap, ModelRegistrationMetadata, PluginModelResult } from "./model.js";
import type { X402Config, X402RequestValidator } from "./payment.js";
...
import type { ViewKind } from "./view-kind.js";
...
export type RouteHandler = (ctx: RouteHandlerContext) => Promise<RouteHandlerResult>;
/** Express-shaped legacy route handler. */
export type LegacyRouteHandler = (req: RouteRequest, res: RouteResponse, runtime: IAgentRuntime) => Promise<void>;
interface BaseRoute {
...
export declare function assertPublicRouteIntent(route: Route, source?: string): void;
...
export type RuntimeEventStorage = PluginEvents & {
    [key: string]: ((params: EventPayloadMap[keyof EventPayloadMap] | EventPayload) => Promise<void>)[] | undefined;
};
/**
 ...
 */
export type AdapterFactory = (agentId: UUID, settings: Record<string, string>) => IDatabaseAdapter | Promise<IDatabaseAdapter>;
export type PluginAppSessionMode = "viewer" | "spectate-and-steer" | "external";
export type PluginAppSessionFeature = "commands" | "telemetry" | "pause" | "resume" | "suggestions";
export type PluginAppControlAction = "pause" | "resume";
export type PluginAppTelemetryValue = JsonValue | PluginAppTelemetryValue[] | {
...
export interface PluginAppBridgeRunContext extends PluginAppBridgeLaunchContext {
    runId?: string;
...
export interface PluginAppBridge {
    ...
    prepareLaunch?: (ctx: PluginAppBridgeLaunchContext) => Promise<PluginAppLaunchPreparation | null>;
    resolveViewerAuthMessage?: (ctx: PluginAppBridgeLaunchContext) => Promise<PluginAppViewerAuthMessage | null>;
    ensureRuntimeReady?: (ctx: PluginAppBridgeLaunchContext) => Promise<void>;
    collectLaunchDiagnostics?: (ctx: PluginAppBridgeRunContext) => Promise<PluginAppLaunchDiagnostic[]>;
    resolveLaunchSession?: (ctx: PluginAppBridgeLaunchContext) => Promise<PluginAppSessionState | null>;
    refreshRunSession?: (ctx: PluginAppBridgeRunContext) => Promise<PluginAppSessionState | null>;
    /**
 ...
 */
export declare const PLUGIN_WIDGET_SLOTS: readonly ["chat-sidebar", "character", "nav-page", "home"];
...
export declare function dedupeModalities(mods: readonly ViewModality[]): ViewModality[];
/**
 ...
 */
export declare function getViewModalities(view: Pick<ViewDeclaration, "modalities" | "viewType">): ViewModality[];
 ...
 */
export declare function collapseViewDeclarations(views: readonly ViewDeclaration[]): CollapsedView[];
/**
...
export interface ViewDeclaration {
     ...
     */
    serverInteract?: (capability: string, params?: Record<string, unknown>) => Promise<unknown>;
...
export interface PluginEventRegistration {
    eventName: string;
    handler: (params: EventPayloadMap[keyof EventPayloadMap] | EventPayload) => Promise<void> | void;
}
 ...
 */
export type RemotePluginRole = "capability" | "sub-agent" | "view-host" | "system" | "user";
/**
 ...
 */
export declare class PermissionNarrowedRejection extends Error {
    readonly capability: string;
    readonly requested: unknown;
    readonly granted: unknown;
    constructor(message: string, capability: string, requested: unknown, granted: unknown);
}
export interface Plugin {
     ...
     */
    applyConfig?: (config: Record<string, string>, runtime: IAgentRuntime) => Promise<void> | void;
    ...
    autoEnable?: {
        ...
        shouldEnable?: (env: Record<string, string | undefined>, config: Record<string, unknown>) => boolean | Promise<boolean>;
    };
}

 ...
 */
export type StateValue = string | number | boolean | null | ProviderValue | object | StateValue[] | {
 ...
 */
export type StreamEventType = "chunk" | "field_validated" | "retry_start" | "error" | "complete";
/**

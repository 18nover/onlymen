 ...
 */
export type HookSource = "bundled" | "managed" | "workspace" | "plugin" | "runtime";
/**
 ...
 */
export declare const DEFAULT_HOOK_PRIORITY: HookPriority;
/**
 ...
 */
export type HookHandler<T extends EventPayload = EventPayload> = (payload: T) => Promise<void> | void;
/**

...
export declare const ModelType: {
    readonly NANO: "TEXT_NANO";
    readonly SMALL: "TEXT_SMALL";
    readonly MEDIUM: "TEXT_MEDIUM";
    readonly LARGE: "TEXT_LARGE";
    readonly MEGA: "TEXT_MEGA";
    readonly TEXT_NANO: "TEXT_NANO";
    readonly TEXT_SMALL: "TEXT_SMALL";
    readonly TEXT_MEDIUM: "TEXT_MEDIUM";
    readonly TEXT_LARGE: "TEXT_LARGE";
    readonly TEXT_MEGA: "TEXT_MEGA";
    readonly RESPONSE_HANDLER: "RESPONSE_HANDLER";
    readonly ACTION_PLANNER: "ACTION_PLANNER";
     ...
     */
    readonly TEXT_EMBEDDING_BATCH: "TEXT_EMBEDDING_BATCH";
    /**
 ...
 */
export type TextGenerationModelType = typeof ModelType.TEXT_NANO | typeof ModelType.TEXT_SMALL | typeof ModelType.TEXT_MEDIUM | typeof ModelType.TEXT_LARGE | typeof ModelType.TEXT_MEGA | typeof ModelType.RESPONSE_HANDLER | typeof ModelType.ACTION_PLANNER | typeof ModelType.TEXT_REASONING_SMALL | typeof ModelType.TEXT_REASONING_LARGE | typeof ModelType.TEXT_COMPLETION;
export declare const TEXT_GENERATION_MODEL_TYPES: readonly ["TEXT_NANO", "TEXT_SMALL", "TEXT_MEDIUM", "TEXT_LARGE", "TEXT_MEGA", "RESPONSE_HANDLER", "ACTION_PLANNER", "REASONING_SMALL", "REASONING_LARGE", "TEXT_COMPLETION"];
export declare function isTextGenerationModelType(modelType: unknown): modelType is TextGenerationModelType;
/**
...
export declare const MODEL_SETTINGS: {
    ...
    readonly TEXT_NANO_MAX_TOKENS: "TEXT_NANO_MAX_TOKENS";
    readonly TEXT_NANO_TEMPERATURE: "TEXT_NANO_TEMPERATURE";
    readonly TEXT_NANO_TOP_P: "TEXT_NANO_TOP_P";
    readonly TEXT_NANO_TOP_K: "TEXT_NANO_TOP_K";
    readonly TEXT_NANO_MIN_P: "TEXT_NANO_MIN_P";
    readonly TEXT_NANO_SEED: "TEXT_NANO_SEED";
    readonly TEXT_NANO_REPETITION_PENALTY: "TEXT_NANO_REPETITION_PENALTY";
    readonly TEXT_NANO_FREQUENCY_PENALTY: "TEXT_NANO_FREQUENCY_PENALTY";
    readonly TEXT_NANO_PRESENCE_PENALTY: "TEXT_NANO_PRESENCE_PENALTY";
    readonly TEXT_MEDIUM_MAX_TOKENS: "TEXT_MEDIUM_MAX_TOKENS";
    readonly TEXT_MEDIUM_TEMPERATURE: "TEXT_MEDIUM_TEMPERATURE";
    readonly TEXT_MEDIUM_TOP_P: "TEXT_MEDIUM_TOP_P";
    readonly TEXT_MEDIUM_TOP_K: "TEXT_MEDIUM_TOP_K";
    readonly TEXT_MEDIUM_MIN_P: "TEXT_MEDIUM_MIN_P";
    readonly TEXT_MEDIUM_SEED: "TEXT_MEDIUM_SEED";
    readonly TEXT_MEDIUM_REPETITION_PENALTY: "TEXT_MEDIUM_REPETITION_PENALTY";
    readonly TEXT_MEDIUM_FREQUENCY_PENALTY: "TEXT_MEDIUM_FREQUENCY_PENALTY";
    readonly TEXT_MEDIUM_PRESENCE_PENALTY: "TEXT_MEDIUM_PRESENCE_PENALTY";
    ...
    readonly TEXT_MEGA_MAX_TOKENS: "TEXT_MEGA_MAX_TOKENS";
    readonly TEXT_MEGA_TEMPERATURE: "TEXT_MEGA_TEMPERATURE";
    readonly TEXT_MEGA_TOP_P: "TEXT_MEGA_TOP_P";
    readonly TEXT_MEGA_TOP_K: "TEXT_MEGA_TOP_K";
    readonly TEXT_MEGA_MIN_P: "TEXT_MEGA_MIN_P";
    readonly TEXT_MEGA_SEED: "TEXT_MEGA_SEED";
    readonly TEXT_MEGA_REPETITION_PENALTY: "TEXT_MEGA_REPETITION_PENALTY";
    readonly TEXT_MEGA_FREQUENCY_PENALTY: "TEXT_MEGA_FREQUENCY_PENALTY";
    readonly TEXT_MEGA_PRESENCE_PENALTY: "TEXT_MEGA_PRESENCE_PENALTY";
    readonly RESPONSE_HANDLER_MAX_TOKENS: "RESPONSE_HANDLER_MAX_TOKENS";
    readonly RESPONSE_HANDLER_TEMPERATURE: "RESPONSE_HANDLER_TEMPERATURE";
    readonly RESPONSE_HANDLER_TOP_P: "RESPONSE_HANDLER_TOP_P";
    readonly RESPONSE_HANDLER_TOP_K: "RESPONSE_HANDLER_TOP_K";
    readonly RESPONSE_HANDLER_MIN_P: "RESPONSE_HANDLER_MIN_P";
    readonly RESPONSE_HANDLER_SEED: "RESPONSE_HANDLER_SEED";
    readonly RESPONSE_HANDLER_REPETITION_PENALTY: "RESPONSE_HANDLER_REPETITION_PENALTY";
    readonly RESPONSE_HANDLER_FREQUENCY_PENALTY: "RESPONSE_HANDLER_FREQUENCY_PENALTY";
    readonly RESPONSE_HANDLER_PRESENCE_PENALTY: "RESPONSE_HANDLER_PRESENCE_PENALTY";
    readonly ACTION_PLANNER_MAX_TOKENS: "ACTION_PLANNER_MAX_TOKENS";
    readonly ACTION_PLANNER_TEMPERATURE: "ACTION_PLANNER_TEMPERATURE";
    readonly ACTION_PLANNER_TOP_P: "ACTION_PLANNER_TOP_P";
    readonly ACTION_PLANNER_TOP_K: "ACTION_PLANNER_TOP_K";
    readonly ACTION_PLANNER_MIN_P: "ACTION_PLANNER_MIN_P";
    readonly ACTION_PLANNER_SEED: "ACTION_PLANNER_SEED";
    readonly ACTION_PLANNER_REPETITION_PENALTY: "ACTION_PLANNER_REPETITION_PENALTY";
    readonly ACTION_PLANNER_FREQUENCY_PENALTY: "ACTION_PLANNER_FREQUENCY_PENALTY";
    readonly ACTION_PLANNER_PRESENCE_PENALTY: "ACTION_PLANNER_PRESENCE_PENALTY";
 ...
 */
export type ResponseSkeletonSpanKind = "literal" | "enum" | "number" | "boolean" | "free-string" | "free-json";
/**
...
export interface GenerateTextParams {
     ...
     * per-field start/done events ({@link import("./streaming.js").StructuredFieldEventCallbacks}).
 ...
 */
export declare function isAudioStreamResult(value: unknown): value is AudioStreamResult;
/**
 ...
 */
export type ResearchTool = ResearchWebSearchTool | ResearchFileSearchTool | ResearchCodeInterpreterTool | ResearchMcpTool;
/**
 ...
 */
export type ResearchOutputItem = ResearchWebSearchCall | ResearchFileSearchCall | ResearchCodeInterpreterCall | ResearchMcpToolCall | ResearchMessageOutput;
/**
...
export interface ModelResultMap {
    ...
    [ModelType.AUDIO]: Buffer | ArrayBuffer | Uint8Array | Record<string, JsonValue>;
    [ModelType.VIDEO]: Buffer | ArrayBuffer | Uint8Array | Record<string, JsonValue>;
 ...
 */
export type StreamableModelType = typeof ModelType.TEXT_NANO | typeof ModelType.TEXT_SMALL | typeof ModelType.TEXT_MEDIUM | typeof ModelType.TEXT_LARGE | typeof ModelType.TEXT_MEGA | typeof ModelType.RESPONSE_HANDLER | typeof ModelType.ACTION_PLANNER | typeof ModelType.TEXT_REASONING_SMALL | typeof ModelType.TEXT_REASONING_LARGE | typeof ModelType.TEXT_COMPLETION;
/**
 ...
 */
export type PluginModelResult<K extends keyof ModelResultMap> = K extends StreamableModelType ? ModelResultMap[K] | TextStreamResult : K extends StreamableAudioModelType ? ModelResultMap[K] | AudioStreamResult : ModelResultMap[K];
export declare function getModelFallbackChain(modelType: ModelTypeName): string[];
export declare function isStreamableModelType(modelType: ModelTypeName): modelType is StreamableModelType;
/**
 ...
 */
export interface ModelHandler<TParams = Record<string, JsonValue | object>, TResult = JsonValue | object> {

...
export interface TaskWorker {
     ...
     */
    execute: (runtime: IAgentRuntime, options: Record<string, JsonValue | object>, task: Task) => Promise<undefined | {
        nextInterval?: number;
    }>;
    /**
     ...
     */
    canExecute?: (runtime: IAgentRuntime, message: Memory, state: State) => Promise<boolean>;
}
/**
 ...
 */
export type PendingUserActionKind = "approval" | "prompt" | "credential" | "clarifying";
/**

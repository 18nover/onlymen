 ...
 */
export type PluginColumnType = "uuid" | "string" | "text" | "integer" | "boolean" | "timestamp" | "jsonb";
/**
 ...
 */
export type PluginFilterValue = string | number | boolean | null | {
...
export interface IPluginStore {
     ...
     */
    query<T = Record<string, unknown>>(table: string, filter?: PluginFilter, options?: PluginQueryOptions): Promise<T[]>;
    /**
     ...
     */
    getById<T = Record<string, unknown>>(table: string, id: UUID): Promise<T | null>;
    /**
     ...
     */
    update(table: string, filter: PluginFilter, set: Record<string, unknown>): Promise<number>;
    /**
...
//# sourceMappingURL=plugin-store.d.ts.map
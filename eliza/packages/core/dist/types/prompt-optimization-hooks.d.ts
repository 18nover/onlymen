...
export interface PromptOptimizationRuntimeHooks {
    mergePromptTemplate(runtime: IAgentRuntime, ctx: MergePromptTemplateContext): Promise<{
        template: string;
        variant: string;
        artifactVersion?: number;
    }>;
    persistRegistryEntry(runtime: IAgentRuntime, entry: PromptOptimizationRegistryWrite): Promise<void>;
    appendBaselineTrace(runtime: IAgentRuntime, ctx: {
        trace: ExecutionTrace;
    }): Promise<void>;
    appendFailureTrace(runtime: IAgentRuntime, ctx: {
        trace: ExecutionTrace;
    }): Promise<void>;
}
//# sourceMappingURL=prompt-optimization-hooks.d.ts.map
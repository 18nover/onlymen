 ...
 */
export type MemoryScope = "shared" | "private" | "room" | "global" | "owner-private" | "user-private" | "agent-private";
 ...
 */
export type MessageChatType = "dm" | "private" | "direct" | "group" | "supergroup" | "channel" | "thread" | "forum" | string;
/**
...
export interface MessageMetadata {
    ...
    voice?: {
        emotion?: {
            label: "happy" | "sad" | "angry" | "nervous" | "calm" | "excited" | "whisper";
            confidence: number;
            vad?: {
                valence: number;
                arousal: number;
            ...
            method: "wav2small_distill" | "audeering_msp_dim" | "sensevoice_inline" | "qwen3_native" | "text_tag" | "explicit_asr_metadata" | "text_audio_heuristic" | "heuristic_fallback";
            modelVersion?: string;
        };
        transcript?: string;
        audio?: {
...
export type MemoryMetadata = (DocumentMetadata | FragmentMetadata | MessageMetadata | DescriptionMetadata | CustomMetadata) & MemoryMetadataBase;
/**

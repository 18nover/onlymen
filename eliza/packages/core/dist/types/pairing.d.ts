 ...
 */
export type PairingChannel = "telegram" | "discord" | "whatsapp" | "signal" | "slack" | "imessage" | "googlechat" | "msteams" | (string & {});
/**
 ...
 */
export declare const DEFAULT_PAIRING_CONFIG: Required<PairingConfig>;
/**
 * Alphabet for generating human-friendly pairing codes.
 * Excludes ambiguous characters (0/O, 1/I/l).
 */
export declare const PAIRING_CODE_ALPHABET = "ABCDEFGHJKLMNPQRSTUVWXYZ23456789";
/**
 * ID labels for different channels - what type of identifier is used
 */
export declare const PAIRING_ID_LABELS: Record<string, string>;
/**
 * Get the ID label for a channel
 */
export declare function getPairingIdLabel(channel: PairingChannel): string;

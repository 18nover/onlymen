 ...
 */
import type { AgentContext } from "./components.js";
import type { JsonValue } from "./primitives.js";
import type { ServiceTypeName } from "./service.js";
export type SearchCategoryFilterType = "string" | "number" | "boolean" | "date" | "enum" | "string[]" | "number[]" | (string & {});
...
export type SearchCategoryRegistryErrorCode = "SEARCH_CATEGORY_NOT_FOUND" | "SEARCH_CATEGORY_DISABLED";
export declare class SearchCategoryRegistryError extends Error {
    readonly code: SearchCategoryRegistryErrorCode;
    readonly category: string;
    constructor(code: SearchCategoryRegistryErrorCode, category: string, message: string);
}

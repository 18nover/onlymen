...
import type { AgentContext, ContextDefinition } from "./contexts.js";
import type { Memory } from "./memory.js";
import type { PromptSegment, ToolDefinition } from "./model.js";
import type { Content, JsonValue } from "./primitives.js";
export type ContextObjectEventType = "message" | "memory" | "provider" | "tool" | "instruction" | "segment" | "metadata" | (string & {});
export type ContextObjectRole = "system" | "user" | "assistant" | "tool" | (string & {});
...
export type ContextEvent = ContextMessageEvent | ContextMemoryEvent | ContextProviderEvent | ContextToolEvent | ContextInstructionEvent | ContextSegmentEvent | ContextMetadataEvent | (ContextEventBase & Record<string, unknown>);

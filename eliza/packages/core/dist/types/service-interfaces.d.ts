 ...
 */
import type { ControlMessageAction } from "./messaging.js";
import type { Content, JsonObject, JsonValue, UUID } from "./primitives.js";
...
export declare abstract class IControlTransportService extends Service {
    static readonly serviceType: "control_transport";
    readonly capabilityDescription = "Dispatches backend control messages to interactive clients.";
...
export declare abstract class ITokenDataService extends Service {
    ...
    readonly capabilityDescription = "Provides standardized access to token market data.";
...
export declare abstract class IWalletService extends Service {
    ...
    abstract transferSol(from: object, to: object, lamports: number): Promise<string>;
}
export declare abstract class ILpService extends Service {
    static readonly serviceType = "lp_pool";
    static readonly allowsMultiple = true;
...
export declare abstract class IMediaGenerationService extends Service {
    static readonly serviceType: "media_generation";
    readonly capabilityDescription: string;
    canGenerateMedia(_request: Pick<MediaGenerationRequest, "mediaType" | "audioKind">): boolean | Promise<boolean>;
    abstract generateMedia(request: MediaGenerationRequest): Promise<MediaGenerationResponse>;
}
 ...
 * mode.
 */
export declare abstract class IScreenCaptureService extends Service {
    static readonly serviceType: "screen_capture";
    readonly capabilityDescription = "Desktop screen/frame capture for live streaming";
...
export declare abstract class IBrowserService extends Service {
    ...
    abstract evaluate<T = JsonValue>(script: string, ...args: JsonValue[]): Promise<T>;
 ...
 */
export declare abstract class IFileStorageService extends Service {
    static readonly serviceType: "aws_s3";
    readonly capabilityDescription: string;
    /** Persist bytes (idempotent by content) and return the served handle. */
    abstract store(bytes: Buffer | Uint8Array, mimeType: string): Promise<StoredFile>;
...
export declare abstract class IMessagingService extends Service {
    static readonly serviceType: "message";
    readonly capabilityDescription = "Platform messaging and channel management capabilities";

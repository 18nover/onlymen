...
export type InteractionFieldType = "text" | "number" | "select" | "checkbox" | "secret" | "image" | "file" | "date" | "time" | "datetime";
...
export type InteractionBlock = FormInteraction | ChoiceInteraction | FollowupsInteraction | TaskInteraction | SecretInteraction;

 ...
 */
export declare const SETUP_STEP_ORDER: SetupStep[];
/**
...
export type SetupInput = {
    step: typeof SetupStep.WELCOME;
    data: WelcomeInput;
} | {
    step: typeof SetupStep.RISK_ACK;
    data: RiskAckInput;
} | {
    step: typeof SetupStep.AUTH;
    data: AuthInput;
} | {
    step: typeof SetupStep.CHANNELS;
    data: ChannelsInput;
} | {
    step: typeof SetupStep.SKILLS;
    data: SkillsInput;
} | {
    step: typeof SetupStep.COMPLETE;
 ...
 */
export declare const SETUP_STEP_LABELS: Record<SetupStep, string>;
/**
 * Descriptions for each setup step.
 */
export declare const SETUP_STEP_DESCRIPTIONS: Record<SetupStep, string>;
/**
 * Get the step index (0-indexed) for a given step.
 */
export declare function getStepIndex(step: SetupStep): number;
/**
 * Get the next step in the sequence, or null if at the end.
 */
export declare function getNextStep(currentStep: SetupStep): SetupStep | null;
/**
 * Get the previous step in the sequence, or null if at the beginning.
 */
export declare function getPreviousStep(currentStep: SetupStep): SetupStep | null;
/**
 * Check if a step has been completed in the given context.
 */
export declare function isStepCompleted(context: SetupContext, step: SetupStep): boolean;
/**
 * Calculate completion percentage from context.
 */
export declare function calculateProgress(context: SetupContext): number;

 ...
 */
import type { JsonObject } from "./primitives.js";
/**
...
export type BuiltInPaymentConfig = "base_usdc" | "solana_usdc" | "polygon_usdc" | "bsc_usdc" | "base_elizaos" | "solana_elizaos" | "solana_degenai";
/**
...
export type X402RequestValidator = (req: import("./plugin.js").RouteRequest) => X402ValidationResult | Promise<X402ValidationResult>;
/**

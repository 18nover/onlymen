 ...
 */
import type { AppShellBackgroundPolicy, ViewHeaderPolicy } from "./plugin.js";
/**
 ...
 */
export declare const SURFACE_ISOLATION_LEVELS: readonly ["in-process", "sandboxed-iframe", "native-webview", "immersive"];
 ...
 */
export declare const SURFACE_CAPABILITIES: readonly ["wallpaper", "background:apply", "navigate", "storage", "agent-surface"];
 ...
 */
export declare function resolveSurfaceManifest(decl: SurfaceManifestBearer | null | undefined): ResolvedSurfaceManifest;
/**
 ...
 */
export declare function resolveSurfaceBackgroundPolicy(decl: SurfaceManifestBearer | null | undefined): AppShellBackgroundPolicy;
/**
 * Whether a resolved manifest grants a capability. The broker's allow-check —
 * a capability not in the manifest is denied.
 */
export declare function surfaceGrants(manifest: ResolvedSurfaceManifest, capability: SurfaceCapability): boolean;
/**
 ...
 */
export declare const IMMERSIVE_WALLPAPER_SURFACE: SurfaceManifest;

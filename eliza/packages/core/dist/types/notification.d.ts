 ...
 */
export type NotificationCategory = "reminder" | "task" | "workflow" | "agent" | "approval" | "message" | "health" | "system" | "general";
/**
...
export declare const DEFAULT_NOTIFICATION_CATEGORY: NotificationCategory;
...
export declare const DEFAULT_NOTIFICATION_SOURCE = "agent";
/** The agent event stream notifications ride on. */
export declare const NOTIFICATION_STREAM: "notification";
/**
 ...
 */
export declare const NOTIFICATION_COUNT_KEY: "count";
/**
 ...
 */
export declare const SILENT_TIER_DEFAULT_EXPIRY_MS: number;
/**
 * Name the triage tier (§C.1) a priority binds to. Pure function of priority so
 * the tier can never drift from the stored record.
 */
export declare function tierForPriority(priority: NotificationPriority): NotificationTier;
/**
 ...
 */
export declare function defaultPriorityForCategory(category: NotificationCategory): NotificationPriority;

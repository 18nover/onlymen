 ...
 */
import type { EvaluationResult } from "./components.js";
import type { ContextEvent } from "./context-object.js";
...
export interface StreamingEventHooks {
    ...
    onContextEvent?: (payload: StreamingContextEventPayload) => MaybePromise<void>;
}
/**

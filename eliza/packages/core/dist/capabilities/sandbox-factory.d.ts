 ...
 */
export declare const E2B_SANDBOX_FACTORY_SERVICE_TYPE: "e2b-sandbox-factory";
...
export interface SandboxFileCapability {
    ...
    write(path: string, data: string, opts?: {
        requestTimeoutMs?: number;
    }): Promise<{
        path: string;
        name: string;
...
export declare function normalizeSandboxEntryType(type: string | undefined): SandboxEntryInfo["type"];

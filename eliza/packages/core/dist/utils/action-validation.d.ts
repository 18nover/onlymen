 ...
 */
import type { AgentContext, Memory, State } from "../types/index.js";
...
export declare function hasActionContext(message: Memory, state: State | undefined, options: ActionContextValidationOptions): boolean;
//# sourceMappingURL=action-validation.d.ts.map
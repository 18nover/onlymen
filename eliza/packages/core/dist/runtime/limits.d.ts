...
export declare const DEFAULT_CHAINING_LOOP_CONFIG: ChainingLoopConfig;
export type TrajectoryLimitKind = "tool_calls" | "repeated_failures" | "required_tool_misses" | "unavailable_tool_calls" | "terminal_only_continuations" | "trajectory_token_budget";
export declare class TrajectoryLimitExceeded extends Error {
...
export declare function mergeChainingLoopConfig(config?: Partial<ChainingLoopConfig>): ChainingLoopConfig;
export declare function assertTrajectoryLimit(params: {
    kind: TrajectoryLimitKind;
    max: number;
    observed: number;
}): void;
...
export declare function getFailureSignature(failure: FailureLike): string | null;
export declare function countRepeatedFailures(failures: readonly FailureLike[], latestFailure: FailureLike): number;
export declare function assertRepeatedFailureLimit(params: {

 ...
 */
export declare function normalizeFactTextKey(value: string): string;
/**
 ...
 */
export declare function findEquivalentFact(runtime: Pick<IAgentRuntime, "getMemories">, memory: Memory): Promise<Memory | null>;
/**
 ...
 */
export declare function mergeStrongerFactMetadata(existing: Memory, incoming: Memory): MemoryMetadata | null;
//# sourceMappingURL=fact-write-dedupe.d.ts.map
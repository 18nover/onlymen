 ...
 */
export type GateableAction = Pick<Action, "name" | "private" | "contextGate" | "contexts" | "roleGate">;
/**
 ...
 */
export declare function actionGateFailure(action: GateableAction, ctx: ActionGateContext): string | undefined;
/** Boolean form of {@link actionGateFailure}. */
export declare function canActionRun(action: GateableAction, ctx: ActionGateContext): boolean;

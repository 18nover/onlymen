...
export type RLMOperation = "peek" | "grep" | "partition" | "map_subcall" | "summarize" | "stitch" | "final";
...
export declare function decideRLMUse(input: RLMPolicyInput): RLMPolicyDecision;

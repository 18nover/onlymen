 ...
 */
export type ResponseHandlerSenderRole = "OWNER" | "ADMIN" | "USER" | "GUEST" | "SYSTEM" | "SELF";
/**
 ...
 */
export interface ResponseHandlerFieldHandleContext<TValue> extends ResponseHandlerFieldContext {
...
export interface ResponseHandlerFieldEvaluator<TValue = unknown> {
     ...
     */
    handle?(ctx: ResponseHandlerFieldHandleContext<TValue>): ResponseHandlerFieldEffect | undefined | Promise<ResponseHandlerFieldEffect | undefined>;
}
...
//# sourceMappingURL=response-handler-field-evaluator.d.ts.map
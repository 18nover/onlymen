...
import type { LocalizedActionExampleResolver } from "./action-catalog.js";
 ...
 */
export type LocalizedExamplesProvider = (input: LocalizedExamplesProviderInput) => Promise<LocalizedActionExampleResolver | null>;
export declare function registerLocalizedExamplesProvider(runtime: IAgentRuntime, provider: LocalizedExamplesProvider): void;
export declare function getLocalizedExamplesProvider(runtime: IAgentRuntime): LocalizedExamplesProvider | null;
export declare function __resetLocalizedExamplesProviderForTests(runtime: IAgentRuntime): void;
//# sourceMappingURL=localized-examples-provider.d.ts.map
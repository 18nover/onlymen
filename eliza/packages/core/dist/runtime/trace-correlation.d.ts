 ...
 */
export declare const TRACE_ENV: {
    readonly TRACE_ID: "ELIZA_TRACE_ID";
    readonly TASK_ID: "ELIZA_TASK_ID";
    readonly PARENT_STEP_ID: "ELIZA_PARENT_TRAJECTORY_STEP_ID";
};
/**
 ...
 */
export declare function resolveTraceCorrelationFromEnv(env?: NodeJS.ProcessEnv): Partial<TraceCorrelation>;
//# sourceMappingURL=trace-correlation.d.ts.map
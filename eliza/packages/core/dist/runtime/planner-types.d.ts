...
import type { ChatMessage, GenerateTextResult, PromptSegment, TextGenerationModelType, ToolChoice, ToolDefinition } from "../types/model.js";
import type { State } from "../types/state.js";
import type { ChainingLoopConfig } from "./limits.js";
import type { TrajectoryRecorder } from "./trajectory-recorder.js";
export type { ContextObject } from "../types/context-object.js";
...
export interface EvaluatorRuntime {
    useModel(modelType: TextGenerationModelType, params: {
...
export interface EvaluatorEffects {
    copyToClipboard?: (clipboard: NonNullable<EvaluationResult["copyToClipboard"]>) => Promise<void> | void;
...
export interface PlannerRuntime {
    ...
    useModel(modelType: TextGenerationModelType, params: {
        ...
        promptSegments?: PromptSegment[];
        providerOptions?: Record<string, unknown>;
    }, provider?: string): Promise<string | GenerateTextResult>;
    logger?: {
        debug?: (context: unknown, message?: string) => void;
        warn?: (context: unknown, message?: string) => void;
...
export interface PlannerLoopParams {
    ...
    executeToolCall: (toolCall: PlannerToolCall, context: {
        trajectory: PlannerTrajectory;
        iteration: number;
    ...
    onToolCallEnqueued?: (toolCall: PlannerToolCall, context: {
        iteration: number;
    }) => Promise<void> | void;

 ...
 *   );
 */
export declare class CleanupTimeoutError extends Error {
    readonly code = "CLEANUP_TIMEOUT";
    constructor(timeoutMs: number);
}
export declare function withCleanup<T>(signal: AbortSignal, timeoutMs: number, cleanup: (cleanupSignal: AbortSignal) => Promise<void>, fn: () => Promise<T>): Promise<T | undefined>;

 ...
 */
export declare function replaceNameTokens(text: string, name: string): string;
/**
 ...
 */
export declare function replaceIndexedNameTokens(text: string, names: readonly string[]): string;

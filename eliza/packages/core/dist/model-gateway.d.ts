 ...
 * direction clean.
 */
export declare const MODEL_GATEWAY_URL_KEY = "ELIZA_MODEL_GATEWAY_URL";
/**
 ...
 */
export declare const MODEL_GATEWAY_TOKEN_KEY = "ELIZA_MODEL_GATEWAY_TOKEN";
/**
 ...
 */
export declare const MODEL_GATEWAY_STRICT_KEY = "ELIZA_MODEL_GATEWAY_STRICT";
/**
 ...
 */
export declare const ELIZA_MODEL_GATEWAY_URL = "ELIZA_MODEL_GATEWAY_URL";
export declare const ELIZA_MODEL_GATEWAY_TOKEN = "ELIZA_MODEL_GATEWAY_TOKEN";
export declare const ELIZA_MODEL_GATEWAY_STRICT = "ELIZA_MODEL_GATEWAY_STRICT";
/**
 ...
 */
export declare const RAW_PROVIDER_KEY_VARS: readonly ["OPENAI_API_KEY", "ANTHROPIC_API_KEY"];
 ...
 */
export declare class ModelGatewayStrictError extends Error {
 ...
 */
export declare function resolveModelGateway(getSetting: GetSettingFn): ModelGatewayResolution;
/**
 ...
 */
export declare function applyModelGateway(raw: OpenAiCompatibleCreds, resolution: ModelGatewayResolution): OpenAiCompatibleCreds;

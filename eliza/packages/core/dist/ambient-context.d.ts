 ...
 * `Symbol.for` key.
 */
export declare function getAmbientSingleton<T>(key: symbol, factory: () => T): T;
/**
 ...
 */
export declare function setAmbientSingleton<T>(key: symbol, value: T): void;
/**
 * Read the process-global singleton at `key` without creating one. Returns
 * `undefined` when nothing has been stored yet.
 */
export declare function peekAmbientSingleton<T>(key: symbol): T | undefined;

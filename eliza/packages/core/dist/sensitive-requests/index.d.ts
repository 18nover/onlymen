 ...
 * shape until then.
 */
export { createSensitiveRequestDispatchRegistry, type DeliveryResult, type DeliveryTarget, type DispatchSensitiveRequest, SENSITIVE_REQUEST_DISPATCH_REGISTRY_SERVICE, type SensitiveRequestDeliveryAdapter, type SensitiveRequestDispatchRegistry, SensitiveRequestDispatchRegistryService, type SensitiveRequestPaymentContextDescriptor, type SensitiveRequestWithPaymentContext, } from "./dispatch-registry.js";

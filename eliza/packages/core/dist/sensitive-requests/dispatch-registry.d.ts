 ...
 */
import type { SensitiveRequestTunnelRouting } from "../sensitive-request-policy.js";
import type { IAgentRuntime } from "../types/runtime.js";
import { Service } from "../types/service.js";
export declare const SENSITIVE_REQUEST_DISPATCH_REGISTRY_SERVICE = "SensitiveRequestDispatchRegistry";
export type DeliveryTarget = "dm" | "owner_app_inline" | "owner_app_oauth" | "cloud_authenticated_link" | "tunnel_authenticated_link" | "public_link" | "instruct_dm_only";
 ...
 */
export interface SensitiveRequestWithPaymentContext extends DispatchSensitiveRequest {
...
export interface SensitiveRequestDispatchRegistry {
     ...
     */
    resolve?(target: DeliveryTarget, channelId: string | undefined, runtime: unknown): SensitiveRequestDeliveryAdapter | undefined;
    list(): SensitiveRequestDeliveryAdapter[];
}
export declare function createSensitiveRequestDispatchRegistry(): SensitiveRequestDispatchRegistry;
export declare class SensitiveRequestDispatchRegistryService extends Service implements SensitiveRequestDispatchRegistry {
    static serviceType: string;
    capabilityDescription: string;
    private readonly registry;
    static start(_runtime: IAgentRuntime): Promise<SensitiveRequestDispatchRegistryService>;
    stop(): Promise<void>;
    register(adapter: SensitiveRequestDeliveryAdapter): void;
    unregister(target: DeliveryTarget): void;
    get(target: DeliveryTarget): SensitiveRequestDeliveryAdapter | undefined;

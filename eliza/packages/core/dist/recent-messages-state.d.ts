...
import type { Memory, State } from "./types/index.js";
/**
 ...
 */
export declare function getRecentMessagesData(state: State | undefined): Memory[];
//# sourceMappingURL=recent-messages-state.d.ts.map
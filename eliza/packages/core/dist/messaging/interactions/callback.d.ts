...
export declare const MAX_CALLBACK_BYTES = 64;
 ...
 */
export declare function encodeReplyCallback(value: string, options?: EncodeReplyCallbackOptions): string | null;
...
export declare function isInteractionCallback(data: unknown): data is string;
/** Decode a callback payload back to the answer, or null when it isn't ours. */
export declare function decodeCallback(data: unknown): DecodedCallback | null;

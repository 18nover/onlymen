...
export declare class CapabilityDeadlineError extends Error {
    readonly cpuMs: number;
    constructor(cpuMs: number);
}
 ...
 */
export declare function applyCapabilityManifest<T>(task: () => Promise<T>, manifest: CapabilityManifest): Promise<T>;
/**
 ...
 * only, not the apex.
 */
export declare function isHostAllowed(host: string, manifest: CapabilityManifest): boolean;
/** Assert `host` is allowed, throwing {@link CapabilityViolationError} otherwise. */
export declare function assertHostAllowed(host: string, manifest: CapabilityManifest): void;
/**
 ...
 */
export declare function isPathAllowed(path: string, manifest: CapabilityManifest): boolean;
/** Assert `path` is allowed, throwing {@link CapabilityViolationError} otherwise. */
export declare function assertPathAllowed(path: string, manifest: CapabilityManifest): void;
/** The frozen env map the governed call should read (empty when none configured). */
export declare function frozenEnv(manifest: CapabilityManifest): Readonly<Record<string, string>>;
/**
 ...
 */
export declare function withCapabilityGovernance(action: Action, manifest: CapabilityManifest): Action;

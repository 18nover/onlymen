 ...
 * planning parameters.
 */
import type { ActionParameters, ActionResult, HandlerCallback, JsonPrimitive, JsonValue, Memory, State, UUID } from "../../types/index.js";
...
export interface IPlanningService {
    ...
    validatePlan(plan: ExtendedActionPlan): Promise<{
        valid: boolean;
        errors: string[];
        warnings: string[];
    }>;

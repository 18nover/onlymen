...
import type { JsonObject, JsonPrimitive, JsonValue, UUID } from "../../types/index.js";
import type { ContextEvent } from "../../types/context-object.js";
export type { JsonObject, JsonPrimitive, JsonValue };
export declare const CONTEXT_OBJECT_TRAJECTORY_VERSION: 5;
export type ContextObjectTrajectoryVersion = typeof CONTEXT_OBJECT_TRAJECTORY_VERSION;

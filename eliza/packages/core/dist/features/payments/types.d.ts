...
export type PaymentRequestStatus = "pending" | "delivered" | "settled" | "failed" | "expired" | "canceled";
export type PaymentContextKind = "any_payer" | "verified_payer" | "specific_payer";
export declare const PAYMENT_CONTEXT_KINDS: readonly PaymentContextKind[];
export declare const PAYMENT_CONTEXT_SCOPES: readonly ["owner", "owner_or_linked_identity"];
...
export interface PaymentRequestsClient {
    ...
    cancel(paymentRequestId: string, reason?: string): Promise<PaymentRequestEnvelope>;
}
/**
...
export interface PaymentBusClient {
    waitFor(paymentRequestId: string, timeoutMs: number): Promise<PaymentSettlementResult>;
    verifyProof(paymentRequestId: string, proof: unknown): Promise<PaymentProofVerification>;
}
/**
...
export declare const PAYMENT_REQUESTS_CLIENT_SERVICE = "PaymentRequestsClient";
export declare const PAYMENT_BUS_CLIENT_SERVICE = "PaymentBusClient";
export declare const PAYMENT_SETTLER_SERVICE = "PaymentSettler";
/**
 ...
 */
export declare function eligibleDeliveryTargetsFor(kind: PaymentContextKind): DeliveryTarget[];

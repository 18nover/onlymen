...
export declare const PersonalityServiceType: {
    CHARACTER_MANAGEMENT: "CHARACTER_MANAGEMENT";
    PERSONALITY_STORE: "PERSONALITY_STORE";
};
/** Legacy memory table for per-user free-text interaction preferences. */
export declare const USER_PREFS_TABLE = "user_personality_preferences";
/** Maximum number of legacy free-text preferences a single user can store. */
export declare const MAX_PREFS_PER_USER = 10;
/** New memory table holding structured personality slots (user + global). */
export declare const PERSONALITY_SLOT_TABLE = "user_personality_slot";
/** Audit log table for every PERSONALITY action mutation. */
export declare const PERSONALITY_AUDIT_TABLE = "personality_audit_log";
/** Synthetic "user id" used to address the global personality slot. */
export declare const GLOBAL_PERSONALITY_SCOPE: "global";
...
export declare const VERBOSITY_VALUES: readonly VerbosityLevel[];
export declare const TONE_VALUES: readonly ToneLevel[];
export declare const FORMALITY_VALUES: readonly FormalityLevel[];
export declare const REPLY_GATE_VALUES: readonly ReplyGateMode[];
export declare const TRAIT_VALUES: readonly PersonalityTrait[];
export declare const SCOPE_VALUES: readonly PersonalityScope[];
/** Maximum custom directives per slot. */
export declare const MAX_CUSTOM_DIRECTIVES = 5;
/** Maximum character length per custom directive. */
export declare const MAX_DIRECTIVE_CHARS = 200;
/** Hard token cap for terse verbosity responses (post-generation truncation). */
export declare const MAX_TERSE_TOKENS = 60;
...
export declare function emptyPersonalitySlot(userId: UUID | typeof GLOBAL_PERSONALITY_SCOPE, agentId: UUID): PersonalitySlot;

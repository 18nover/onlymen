 ...
 */
export declare const SUB_AGENT_CREDENTIAL_BRIDGE_SERVICE = "SubAgentCredentialBridge";
export declare const SUB_AGENT_CREDENTIAL_BRIDGE_ADAPTER_SERVICE = "SubAgentCredentialBridgeAdapter";
export declare const SUB_AGENT_CREDENTIAL_PARENT_CAPABILITY_SERVICE = "ACP_SUBPROCESS_SERVICE";
export declare const SUB_AGENT_CHILD_DECISION_BUS_SERVICE = "SubAgentChildDecisionBus";
export declare const SUB_AGENT_CHILD_RESULTS_CLIENT_SERVICE = "SubAgentChildResultsClient";

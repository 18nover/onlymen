...
export declare const SECRET_VALUE_MAX_LENGTH = 65536;
export declare const SECRET_DESCRIPTION_MAX_LENGTH = 1024;
export declare const SECRET_KEY_PATTERN: RegExp;
export declare const MAX_ACCESS_LOG_ENTRIES = 1000;
export type SecretLevel = "global" | "world" | "user";
export type SecretType = "api_key" | "private_key" | "public_key" | "url" | "credential" | "token" | "config" | "secret";
export type SecretStatus = "missing" | "generating" | "validating" | "invalid" | "valid" | "expired" | "revoked";
export type SecretPermissionType = "read" | "write" | "delete" | "share";
export type ValidationStrategy = "none" | "api_key:openai" | "api_key:anthropic" | "api_key:groq" | "api_key:google" | "api_key:mistral" | "api_key:cohere" | "url:valid" | "url:reachable" | "custom";
 ...
 * on the wire.
 */
export declare const SECRET_HANDLE_MARKER: "eliza:secret-handle:v1";
/**
 ...
 */
export declare function serializeSecretHandle(handle: SecretHandle): string;
/** Type guard: is a stored string a serialized {@link SecretHandle}? */
export declare function isSerializedSecretHandle(value: string | null): boolean;
/**
 * Parse a serialized handle back into a {@link SecretHandle}, or `null` if the
 * string is not a serialized handle / is malformed.
 */
export declare function parseSecretHandle(value: string | null): SecretHandle | null;
/**
...
export interface ISecretBrokerClient {
     ...
     */
    issueHandle(key: string, context: SecretContext): Promise<SecretHandle | null>;
    /**
     ...
     */
    storeSecret?(key: string, value: string, context: SecretContext): Promise<boolean>;
 ...
 */
export type SecretChangeCallback = (key: string, value: string | null, context: SecretContext) => Promise<void>;
/**
 ...
 */
export type CustomValidator = (key: string, value: string) => Promise<ValidationResult>;
/**
...
export type FormFieldType = "text" | "password" | "textarea" | "select" | "checkbox" | "radio" | "file" | "hidden";
...
export declare class PermissionDeniedError extends SecretsError {
    constructor(key: string, action: SecretPermissionType, context: SecretContext);
}
export declare class SecretNotFoundError extends SecretsError {
    constructor(key: string, context: SecretContext);
}
export declare class ValidationError extends SecretsError {
    constructor(key: string, message: string, details?: Record<string, unknown>);
}
export declare class EncryptionError extends SecretsError {
    constructor(message: string, details?: Record<string, unknown>);
}
export declare class StorageError extends SecretsError {
    constructor(message: string, details?: Record<string, unknown>);
}

 ...
 */
export declare const SECRETS_BROKER_URL_KEY = "ELIZA_SECRETS_BROKER_URL";
export declare const SECRETS_BROKER_TOKEN_KEY = "ELIZA_SECRETS_BROKER_TOKEN";
export declare const SECRETS_BROKER_STRICT_KEY = "ELIZA_SECRETS_BROKER_STRICT";
/**
 ...
 */
export declare class SecretsBrokerUnavailableError extends Error {
 ...
 */
export declare function resolveSecretsBrokerConfig(getSetting: GetSettingFn): SecretsBrokerConfig | undefined;
export {};
//# sourceMappingURL=broker-config.d.ts.map
 ...
 *   from this account).
 */
export type PrivacyLevel = "owner_only" | "team_visible" | "semi_public" | "public";
export declare const PRIVACY_LEVELS: PrivacyLevel[];
export declare const DEFAULT_PRIVACY_LEVEL: PrivacyLevel;
/**
 ...
 */
export declare function privacyAtLeast(actual: PrivacyLevel, required: PrivacyLevel): boolean;
/**
 ...
 */
export declare function getAccountPrivacy(account: ConnectorAccount): PrivacyLevel;

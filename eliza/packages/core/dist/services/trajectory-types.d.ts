...
export type { RecordedRetrievalPerStageScores, RecordedRetrievalStageEntry, RecordedToolSearchStage, } from "../runtime/trajectory-recorder.js";
export declare const ELIZA_NATIVE_TRAJECTORY_FORMAT: "eliza_native_v1";
export type ElizaNativeTrajectoryFormat = typeof ELIZA_NATIVE_TRAJECTORY_FORMAT;
export declare const ELIZA_NATIVE_MODEL_BOUNDARIES: readonly ["vercel_ai_sdk.generateText", "vercel_ai_sdk.streamText"];
export type ElizaNativeModelBoundary = (typeof ELIZA_NATIVE_MODEL_BOUNDARIES)[number];
...
export interface TrajectoryListResult<TTrajectory extends TrajectorySummaryRecord = TrajectorySummaryRecord> {
...
export declare const TRAJECTORY_STEP_SCRIPT_MAX_CHARS = 4096;
...
export interface TrajectoryFlattenedLlmCallRecord extends TrajectoryLlmCallRecord {
    trajectoryId: string;
    agentId: string;
    source?: string;
    status: TrajectoryStatus;
...
export interface ElizaNativeTrajectoryRow extends Pick<TrajectoryFlattenedLlmCallRecord, "trajectoryId" | "agentId" | "source" | "status" | "scenarioId" | "batchId" | "stepId" | "callId" | "stepIndex" | "callIndex" | "timestamp" | "purpose" | "actionType" | "stepType" | "tags" | "model" | "modelVersion" | "modelType" | "provider"> {
...
//# sourceMappingURL=trajectory-types.d.ts.map
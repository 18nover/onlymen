 ...
 */
export declare function getPairingService(runtime: IAgentRuntime): Promise<PairingService | null>;
/**
 ...
 * ```
 */
export declare function checkPairingAllowed(runtime: IAgentRuntime, params: PairingCheckParams): Promise<PairingCheckResult>;
/**
 * Build the pairing reply message sent to unauthorized users.
 */
export declare function buildPairingReplyMessage(params: {
    channel: PairingChannel;
    senderId: string;
    code: string;
    idLabel?: string;
 ...
 */
export declare function addToAllowlist(runtime: IAgentRuntime, channel: PairingChannel, senderId: string, metadata?: Record<string, string>): Promise<boolean>;
/**
 * Remove a sender from the allowlist.
 */
export declare function removeFromAllowlist(runtime: IAgentRuntime, channel: PairingChannel, senderId: string): Promise<boolean>;
/**
 * Check if a sender is in the allowlist.
 */
export declare function isInAllowlist(runtime: IAgentRuntime, channel: PairingChannel, senderId: string): Promise<boolean>;
/**
 ...
 */
export declare function approvePairingCode(runtime: IAgentRuntime, channel: PairingChannel, code: string): Promise<string | null>;
//# sourceMappingURL=pairing-integration.d.ts.map
...
export type WalletRpcCredentialKey = 'ALCHEMY_API_KEY' | 'INFURA_API_KEY' | 'ANKR_API_KEY' | 'NODEREAL_BSC_RPC_URL' | 'QUICKNODE_BSC_RPC_URL' | 'HELIUS_API_KEY' | 'BIRDEYE_API_KEY' | 'ETHEREUM_RPC_URL' | 'BASE_RPC_URL' | 'AVALANCHE_RPC_URL' | 'BSC_RPC_URL' | 'SOLANA_RPC_URL';
 ...
 */
export type EvmSigningCapabilityKind = 'local' | 'steward-self' | 'steward-cloud' | 'cloud-view-only' | 'none';

...
- **How:** Message to domain lead (Nadia, Morgan, Seth, etc.)
...
- **How:** `ORG_ESCALATION` event to Andrew
- **Response:** Within 4 hours
- **Example:** "Nadia and Morgan disagree on where this logic lives." "I need more time than the sprint allows."

### Level 4: Human Operator
- **When:** Business decisions, budget constraints, external commitments
- **How:** Andrew escalates to human operator
...
|---------|---------------|-----------------|
| Security vulnerability discovered | Level 2 (Seth) | 30 minutes |
| Two agents disagree after one debate round | Level 3 (Andrew) | 2 hours |
| Blocker open for >2 hours | Level 3 (Andrew) | 1 hour |
| Production incident (Sev1/Sev2) | Level 3 (Andrew) | 15 minutes |
...
| Feature request from external | Level 3 (Andrew) | 4 hours |

## De-escalation

- If the conflict resolves naturally, inform Andrew to close the escalation
...
2. Wait 30 minutes
3. If still blocked, escalate to Andrew
4. Andrew has authority to reassign, deprioritize, or resolve

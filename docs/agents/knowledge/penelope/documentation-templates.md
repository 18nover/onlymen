...
Standard documentation templates for the Penelope agent, including README, API docs, architecture docs, deployment guides, runbooks, release notes, post-mortems, and ADRs.

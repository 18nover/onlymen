  ...
  return {
    expo: {
      ...
      ios: {
        ...
        bundleIdentifier: 'gay.onlymen.app',
      ...
      android: {
        ...
        // A real Firebase project is not required for local builds - see
        // docs/build.md. Fall back to the checked-in placeholder so
        // prebuild works on a fresh clone.
        googleServicesFile: fs.existsSync('./google-services.json')
      ...
      extra: {
        eas: {
          ...
          projectId: 'f6360dec-4273-4b03-a476-8c1abfa948e9',
        },
      },
    },
  }
